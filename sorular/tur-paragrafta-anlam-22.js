// Türkçe — Paragrafta Anlam | Havuz partisi 22 (tur-pa-2181…2200) | Alan: tohum, tarım ve gıda güvenliği
window.LGS_BANK = window.LGS_BANK || {};
(window.LGS_BANK["paragrafta-anlam"] = window.LGS_BANK["paragrafta-anlam"] || []).push(
{ id: "tur-pa-2181", kazanim: "T.8.3.16", kademe: 0, zorluk: 1,
  soru: `Gübreyi göz kararı atmak, hastalığı görmeden ilaç yazmaya benzer. Toprak analizi bunun önüne geçer: tarlanın birkaç noktasından alınan örnekler laboratuvara gönderilir, hangi besinin ne kadar eksik olduğu ölçülür. Sonuç elimize geldiğinde ne kadar gübre gerektiğini biliriz. Böylece hem gereksiz masraftan kurtuluruz hem de fazla gübrenin toprağa ve suya verdiği zararı önleriz.

**Bu parçanın konusu aşağıdakilerden hangisidir?**`,
  gorsel: null,
  secenekler: ["Gübrenin fazlasının çevreye verdiği zarar", "Gübre miktarının toprak analiziyle belirlenmesi", "Toprakta ölçülebilen bütün besin maddeleri", "Tarlada gübre kullanımından vazgeçilmesi"],
  dogru: 1,
  hatalar: ["metinde var ama ilgisiz: Fazla gübrenin toprağa ve suya zararı son cümlede geçiyor ama orada anlatılan şey değil, analizin bir yararıdır.", null, "aşırı genelleme: Metin hangi besinin eksik olduğunun ölçüldüğünü söylüyor; besinlerin tamamını tanıtan bir liste sunmuyor.", "ters yön: Parça gübreyi bırakmayı değil, gerektiği kadar kullanmayı savunuyor."],
  aciklama: `Konu, “Bu parçada ne anlatılıyor?” sorusunun karşılığıdır; bütün cümlelerin ortak paydasıdır.

Adım 1: Cümleleri tek tek oku. İlk cümle göz kararı gübrelemeyi yeriyor, ikinci cümle analizin nasıl yapıldığını anlatıyor, üçüncü cümle sonucun ne işe yaradığını söylüyor, son cümle de yararlarını sıralıyor.
Adım 2: Hepsinin ortak paydası şu: gübre miktarını tahminle değil, toprak analiziyle belirlemek.

En güçlü çeldirici A. Çevre zararı metinde gerçekten geçiyor; ama orası parçanın anlattığı şey değil, analiz yapmanın bir kazancıdır.

Sık yapılan hata: Son cümlede geçen bir ayrıntıyı konu sanmak. Konu, tek bir cümlenin değil, bütün cümlelerin buluştuğu noktadır. Cevap B.` },

{ id: "tur-pa-2182", kazanim: "T.8.3.17", kademe: 0, zorluk: 1,
  soru: `Sofrada artan ekmeği çöpe atarken yalnızca bir dilimden vazgeçtiğimizi sanırız. Oysa o dilimin arkasında ekilen tohum, harcanan su, çalışan eller ve yakılan yakıt vardır. Ekmeği israf etmek, aslında bütün bu emeği israf etmektir. Bu yüzden gerektiği kadar almak ve kalanı saklamayı bilmek, küçük değil büyük bir tutumluluktur.

**Bu parçanın ana düşüncesi aşağıdakilerden hangisidir?**`,
  gorsel: null,
  secenekler: ["Bir dilim ekmeği atmak önemsiz bir kayıp sayılır.", "Ekmek üretiminde su ve yakıt da harcanmaktadır.", "Ekmek israfı, arkasındaki bütün emeğin israfıdır.", "Tohumdan sofraya uzanan yol pek çok aşamadan oluşur."],
  dogru: 2,
  hatalar: ["ters yön: Metin tam tersini söylüyor; atılan dilimin küçük değil, arkasındaki emek kadar büyük bir kayıp olduğunu anlatıyor.", "metinde var ama ilgisiz: Su ve yakıt ikinci cümlede sayılıyor ama bunlar yargı değil, yargıyı destekleyen örneklerdir.", null, "kısmen doğru: Aşamaların çokluğu metinden çıkarılabilir; ancak yazarın kabul ettirmek istediği yargı bu değil, o emeğin israf edilmesidir."],
  aciklama: `Ana düşünce, yazarın okura kabul ettirmek istediği asıl yargıdır. Çoğu zaman parçada doğrudan yazılıdır.

Adım 1: Üçüncü cümleye bak: “Ekmeği israf etmek, aslında bütün bu emeği israf etmektir.” Yargı burada açıkça duruyor.
Adım 2: Öteki cümleler bu yargıyı hazırlıyor: ikinci cümle emeğin nelerden oluştuğunu sayıyor, son cümle de yargıdan çıkan öneriyi veriyor.

En güçlü çeldirici D. Tohum, su, emek gerçekten sıralanmış; ama o sıralama parçanın amacı değil, kanıtıdır.

Sık yapılan hata: Ana düşünce yerine onu destekleyen örneği seçmek. Örnek “neyle anlatıldığı”, ana düşünce “ne anlatıldığı” sorusunun cevabıdır. Cevap C.` },

{ id: "tur-pa-2183", kazanim: "T.8.3.18", kademe: 0, zorluk: 2,
  soru: `Market rafındaki iki tarih aynı şey değildir. Çabuk bozulan ürünlerde “son tüketim tarihi” yazar; bu tarih geçtikten sonra ürün, görünüşü ve kokusu düzgün olsa bile tüketilmemelidir. Kuru bakliyat, makarna, bisküvi gibi ürünlerde ise “tavsiye edilen tüketim tarihi” bulunur; bu tarih ürünün bozulacağı günü değil, üreticinin tazelik ve lezzet güvencesi verdiği süreyi bildirir. Ambalaj açılmadıysa ve saklama koşullarına uyulduysa bu ürünler tarihten sonra da güvenli olabilir. İki tarihi birbirine karıştırmak kimi zaman sağlığı riske atar, kimi zaman da sapasağlam gıdayı çöpe gönderir.

**Bu parçada aşağıdakilerden hangisine __değinilmemiştir__?**`,
  gorsel: null,
  secenekler: ["Son tüketim tarihi geçen ürünlerin tüketilmemesi gerektiğine", "Tavsiye edilen tüketim tarihinin hangi ürünlerde bulunduğuna", "İki tarihin birbirine karıştırılmasının yol açtığı sonuçlara", "Tarihlerin ambalajın hangi yüzüne yazılması gerektiğine"],
  dogru: 3,
  hatalar: ["metinde var ama ilgisiz: İkinci cümle bunu açıkça söylüyor; görünüşü düzgün olsa bile tüketilmemesi gerektiği yazıyor.", "metinde var ama ilgisiz: Üçüncü cümlede kuru bakliyat, makarna ve bisküvi örnek olarak veriliyor.", "metinde var ama ilgisiz: Son cümlede iki sonuç sayılıyor: sağlığın riske girmesi ve sağlam gıdanın çöpe gitmesi.", null],
  aciklama: `“Değinilmemiştir” sorusunda iş basittir: her şıkkı metinde tek tek ara, bulamadığın şık cevaptır.

Adım 1: A’yı ara. İkinci cümlede var.
Adım 2: B’yi ara. Üçüncü cümlede ürün örnekleri sayılmış.
Adım 3: C’yi ara. Son cümlede iki sonuç da yazılı.
Adım 4: D’yi ara. Parça tarihlerin ne anlama geldiğini anlatıyor; ambalajın neresine yazıldığından hiç söz etmiyor.

En güçlü çeldirici B. “Hangi ürünlerde bulunduğu” ifadesi soyut geldiği için metinde yokmuş gibi görünür; oysa kuru bakliyat, makarna ve bisküvi tam olarak bunun cevabıdır.

Sık yapılan hata: Şıkkın sözcüklerini metinde birebir aramak. Metin aynı bilgiyi başka sözcüklerle vermiş olabilir. Cevap D.` },

{ id: "tur-pa-2184", kazanim: "T.8.3.16", kademe: 0, zorluk: 2,
...
**Numaralanmış cümlelerden hangisi düşüncenin akışını __bozmaktadır__?**`,
  gorsel: `<table class="tablo"><tr><th>No</th><th>Cümle</th></tr><tr><td>I</td><td>Seranın örtüsünden giren güneş ışığı, içerideki havayı ve toprağı ısıtır.</td></tr><tr><td>II</td><td>Isınan hava dışarı kolayca kaçamadığı için sıcaklık, dışarıdakinin epeyce üstüne çıkar.</td></tr><tr><td>III</td><td>Bu yüzden çatı ve yan pencereler gün içinde açılıp kapatılarak sıcaklık dengelenir.</td></tr><tr><td>IV</td><td>Havalandırma aynı zamanda yaprakların üzerinde biriken fazla nemi de dışarı atar.</td></tr><tr><td>V</td><td>Örtü altında yetiştirilen domatesler, sıraların arasında tek tek elle toplanır.</td></tr></table>`,
  secenekler: ["II", "III", "IV", "V"],
  dogru: 3,
  hatalar: ["kısmen doğru: II, seranın neden bu kadar ısındığını açıklıyor; onu çıkarırsan III’teki “bu yüzden” dayanaksız kalır.", "kısmen doğru: III, ısınmanın sonucunda yapılan işi veriyor; havalandırmayı parçaya sokan cümle odur.", "kısmen doğru: IV, III’te açılan havalandırma konusunu sürdürüyor, ona ikinci bir yarar ekliyor.", null],
  aciklama: `Akışı bozan cümleyi bulmak için parçanın zincirini çıkar: I ışığın seraya girip ısıttığını, II ısının içeride kaldığını, III bu yüzden pencerelerin açılıp kapatıldığını, IV havalandırmanın nemi de attığını söylüyor. Zincir “ısınma → havalandırma” yönünde ilerliyor.

V ise domateslerin nasıl toplandığını anlatıyor. Sera konusuyla ilgilidir, hatta doğrudur; ama zincirin hiçbir halkasına bağlanmaz, üstelik konuyu sıcaklıktan hasada kaydırır.

En güçlü çeldirici C. IV, “bu yüzden” gibi bir bağlayıcı taşımadığı için fazladan bir cümle sanılabilir; oysa III’te başlayan havalandırma konusunu tamamlar.

Sık yapılan hata: Akışı bozan cümleyi ararken konuyla ilgisiz bir cümle beklemek. Bozan cümle çoğu zaman konuyla ilgilidir; onu ele veren, düşünce zincirinin dışında durmasıdır. Cevap D.` },

{ id: "tur-pa-2185", kazanim: "T.8.3.17", kademe: 0, zorluk: 2,
  soru: `Aynı tarlaya her yıl aynı ürünü ekmek, kolay görünen ama pahalıya mal olan bir alışkanlıktır. Her bitki topraktan kendi ihtiyacı olan besinleri çeker; yıllarca tekrarlanınca o besinler azalır. Üstelik o ürünün hastalıkları ve zararlıları toprakta kışlayarak birikir. Ekilen ürünü değiştirmek bu zinciri kırar: zararlı, ertesi yıl beslenebileceği bitkiyi bulamaz. Nohut, mercimek gibi baklagiller ise köklerindeki bakteriler sayesinde toprağa azot bırakır; onlardan sonra ekilen buğday daha az gübreyle yetinir.

**Bu parçanın ana düşüncesi aşağıdakilerden hangisidir?**`,
  gorsel: null,
  secenekler: ["Ekilen ürünü sırayla değiştirmek toprağı da ürünü de korur.", "Baklagiller topraktaki azot miktarını artıran bitkilerdir.", "Tarımda gübre ve ilaç kullanımından büsbütün vazgeçilmelidir.", "Toprakta kışlayan zararlılar bitki hastalıklarının tek nedenidir."],
  dogru: 0,
  hatalar: [null, "metinde var ama ilgisiz: Baklagillerin azot bırakması son cümlede geçiyor ama bu, ürün değişiminin yararlarından yalnızca biridir.", "aşırı genelleme: Metin gübreden vazgeçmeyi değil, daha az gübreyle yetinmeyi söylüyor; “büsbütün” sözü parçanın sınırını aşar.", "aşırı genelleme: Zararlıların toprakta birikmesi metinde var; ancak hastalıkların “tek nedeni” olduğu söylenmiyor."],
  aciklama: `Ana düşünceyi bulmak için “Yazar beni neye ikna etmek istiyor?” diye sor.

Adım 1: İlk cümle bir sorunu ortaya koyuyor: aynı ürünü tekrar tekrar ekmek pahalıya mal olur.
Adım 2: İkinci ve üçüncü cümleler nedenleri sıralıyor: besinlerin azalması, zararlıların birikmesi.
Adım 3: Dördüncü ve beşinci cümleler çözümü ve kazancını veriyor: ürünü değiştirmek zinciri kırar, baklagiller toprağı zenginleştirir.
Adım 4: Hepsi tek yargıda buluşuyor: ekilen ürünü sırayla değiştirmek hem toprağı hem ürünü korur.

En güçlü çeldirici B. Son cümledeki bilgi doğru ve metinde açıkça var; ama tek başına parçanın tamamını değil, yalnızca son cümlesini karşılar.

Sık yapılan hata: Parçanın en teknik, en “bilgi gibi duran” cümlesini ana düşünce sanmak. Ana düşünce bütünü kapsamalıdır. Cevap A.` },

{ id: "tur-pa-2186", kazanim: "T.8.3.21", kademe: 0, zorluk: 2,
  soru: `Tohumu toprağa gömerken “ne kadar derine?” sorusunun tek bir cevabı yoktur. Küçük tohumların içinde çok az yedek besin bulunur; bu yedek, filizin toprağın yüzüne çıkmasına ancak yeter. Derine gömülen bir marul tohumu, yukarıya varamadan gücünü tüketir. Fasulye gibi iri tohumlarda ise yedek besin çoktur; buna karşılık yüzeye çok yakın bırakılırlarsa kuruyan toprakta çimlenemez ya da kuşlara yem olur. Bahçıvanların kuşaklardır uyguladığı ölçü bu yüzden şaşırtıcı değildir: - - - -.

**Bu parçada boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**`,
  gorsel: null,
  secenekler: ["ekim derinliği yalnızca toprağın nemine bakılarak belirlenir", "her tohum bir parmak boyu kadar derine, aynı ölçüde ekilir", "tohum, kendi kalınlığının iki üç katı kadar derine ekilir", "küçük tohumlarla iri tohumlar ayrı tarlalara ekilerek yetiştirilir"],
  dogru: 2,
  hatalar: ["kısmen doğru: Kuruma tehlikesi metinde geçiyor ama derinliği belirleyen asıl ölçüt nem değil, tohumun kendi büyüklüğüdür.", "ters yön: Parça ilk cümlede “tek bir cevabı yoktur” diyor; bütün tohumlara aynı derinliği veren bir ölçü metnin söylediğinin tersidir.", null, "aşırı genelleme: Metin tohumları ayrı tarlalara ayırmaktan değil, aynı tarlada farklı derinliğe ekmekten söz ediyor."],
  aciklama: `Boşluk doldurmada önce boşluğun önündeki cümlelere bakılır; parça oraya kadar hangi düşünceyi kurmuşsa boşluk onu bağlar.

Adım 1: Parça iki örnek veriyor. Küçük tohum derine gömülürse yüzeye çıkamıyor; iri tohum yüzeye yakın kalırsa kuruyor ya da kuşa yem oluyor.
Adım 2: İki örnek de aynı yere çıkıyor: uygun derinlik, tohumun büyüklüğüne bağlıdır.
Adım 3: Boşluktan önceki “bahçıvanların kuşaklardır uyguladığı ölçü” ifadesi, tek bir sayı değil, tohuma göre değişen bir oran ister. “Kendi kalınlığının iki üç katı” tam olarak böyle bir orandır.

En güçlü çeldirici A. Nem metinde geçtiği için doğru sanılır; ama nem, iri tohumların neden yüzeye bırakılmaması gerektiğini açıklayan bir ayrıntıdır, derinliği belirleyen ölçüt değildir.

Sık yapılan hata: Boşluğa, metinde geçen herhangi bir bilgiyi koymak. Boşluk, metinde geçen bilgiyi değil, metnin vardığı sonucu ister. Cevap C.` },

{ id: "tur-pa-2187", kazanim: "T.8.3.18", kademe: 0, zorluk: 2,
  soru: `Bir meyve bahçesinde işin en sessiz bölümünü arılar yapar. Çiçekten çiçeğe nektar toplarken tüylerine yapışan çiçek tozunu da yanlarında taşırlar; tozlaşma böyle gerçekleşir. Tozlaşmanın eksik kaldığı bir çiçekten ya meyve hiç tutmaz ya da küçük, yamuk bir meyve oluşur. Bu yüzden çiçeklenme dönemi, bahçede ilaçlama takviminin en dikkatli tutulduğu zamandır. Kimi üreticiler bu haftalarda bahçelerine arı kovanı getirtir; seralarda ise çiçekleri dolaşması için bombus arısından yararlanılır.

**Bu parçadan hareketle aşağıdakilerden hangisi __söylenemez__?**`,
  gorsel: null,
  secenekler: ["Kovan getirilmesi bahçedeki meyvenin tadını değiştirir.", "Arılar nektar toplarken çiçek tozunu da taşımaktadır.", "Tozlaşması eksik kalan çiçekler kusurlu meyve verebilir.", "Seralarda tozlaşma için bombus arısından yararlanılır."],
  dogru: 0,
  hatalar: [null, "metinde var ama ilgisiz: İkinci cümle bunu açıkça söylüyor; tüylere yapışan çiçek tozu çiçekten çiçeğe taşınıyor.", "metinde var ama ilgisiz: Üçüncü cümlede meyvenin hiç tutmaması ya da küçük, yamuk oluşması anlatılıyor.", "metinde var ama ilgisiz: Son cümlede seralarda bombus arısı kullanıldığı belirtiliyor."],
  aciklama: `“Söylenemez” sorusunda metne dayanmayan yargıyı ararsın. Üç şık metinde vardır, biri yoktur.

Adım 1: B’yi ara: ikinci cümlede var.
Adım 2: C’yi ara: üçüncü cümlede var.
Adım 3: D’yi ara: son cümlede var.
Adım 4: A’yı ara. Metin kovan getirmenin tozlaşmayı artırdığını ima ediyor; tatla ilgili tek bir söz bile yok.

En güçlü çeldirici C. “Verebilir” sözcüğü ihtiyatlı durduğu için metnin söylemediği bir yorum sanılabilir; oysa metin bunu “küçük, yamuk bir meyve oluşur” diyerek zaten söylüyor.

Sık yapılan hata: Metinden mantıklı görünen bir sonuç türetip onu metnin söylediği saymak. Arı çoğalınca meyve iyileşir sanmak akla yatkındır ama bu parçada yazmaz. Cevap A.` },

{ id: "tur-pa-2188", kazanim: "T.8.3.19", kademe: 0, zorluk: 2,
  soru: `Bir kasabada yıllardır aynı kavunun ekildiğini duyduğunuzda, aslında bir bilgi birikiminden söz ediliyordur. Yerel çeşitler, o toprağın suyuna, rüzgârına ve hastalığına göre kuşaklar boyunca seçile seçile bugüne gelmiştir. Verimleri yeni çeşitlerin gerisinde kalabilir; buna karşılık kendi tohumlarını verirler, yani üretici her yıl tohum satın almak zorunda kalmaz. Bu tohumlar sandıkta değil tarlada korunur: ekilmeyen bir çeşit birkaç kuşakta unutulur. Bu yüzden yerel çeşitleri yaşatmanın en sağlam yolu, onları ekmeye ve birbirine vermeye devam etmektir.

**Bu parçaya en uygun başlık aşağıdakilerden hangisidir?**`,
  gorsel: null,
  secenekler: ["Yeni Çeşitlerin Yüksek Verimi", "Ekildikçe Yaşayan Yerel Tohumlar", "Kavun Yetiştiriciliğinin İncelikleri", "Tohum Satın Alırken Dikkat Edilecekler"],
  dogru: 1,
  hatalar: ["ters yön: Parça yeni çeşitleri değil yerel çeşitleri savunuyor; verim üstünlüğü yalnızca bir karşılaştırma olarak geçiyor.", null, "metinde var ama ilgisiz: Kavun yalnızca ilk cümlede örnek olarak anılıyor; parça kavun yetiştirmeyi hiç anlatmıyor.", "kısmen doğru: Tohum satın almak metinde geçiyor ama bir alışveriş önerisi olarak değil, yerel çeşidin üstünlüğünü göstermek için."],
  aciklama: `Başlık, parçanın bütününü kapsamalı ve ana düşünceyi yansıtmalıdır.

Adım 1: Parçanın iki yargısını çıkar. Birincisi: yerel çeşitler o yere göre seçilmiş bir birikimdir ve kendi tohumunu verir. İkincisi: bu tohumlar ancak ekilerek korunur, ekilmeyen unutulur.
Adım 2: İki yargıyı birden karşılayan başlığı ara. “Ekildikçe Yaşayan Yerel Tohumlar” hem “yerel” hem “ekildikçe yaşar” bölümünü içine alıyor.

En güçlü çeldirici D. Tohum satın almak son derece somut bir ayrıntı olduğu için akılda kalır; ama metin alışveriş tavsiyesi vermiyor, yerel çeşidin üreticiyi her yıl tohum almaktan kurtardığını söylüyor.
...
**Bu parçada yazar, aşağıdakilerden hangisini anlatmak istemektedir?**`,
  gorsel: null,
  secenekler: ["Görünüşü kusurlu meyvelerin ötekilerden daha tatlı olduğunu", "Alıcının görünüş alışkanlığının ürün kaybına yol açtığını", "Pazarcıların ürünleri tezgâha özenle dizdiğini", "Meyve kabuğundaki beneklerin zararsız olduğunu"],
  dogru: 1,
  hatalar: ["aşırı genelleme: Metin “tadı geri değildir” diyor, yani eşit sayıyor; “daha tatlı” yargısı parçanın söylediğini aşar.", null, "metinde var ama ilgisiz: Kusurluların arkaya konması ikinci cümlede geçiyor ama bu, yazarın anlatmak istediği düşünce değil, düşüncesinin çıkış noktasıdır.", "kısmen doğru: Kusurun kabukta kaldığı doğrudur ve metinde vardır; ancak yazar bir sağlık bilgisi değil, alışkanlığımızın sonucunu anlatıyor."],
  aciklama: `Örtülü anlam sorusunda, bütün cümlelerin birlikte gösterdiği yargıyı ararsın; yazar onu çoğu zaman doğrudan yazmaz.

Adım 1: Zinciri kur. Alıcı düzgün olanı seçiyor → satıcı çarpık olanları getirmiyor → o meyveler depoda kalıyor ya da hiç toplanmıyor.
Adım 2: Son cümle zinciri bağlıyor: eksik olan meyve değil, gözümüzün alışkanlığı. Yani kaybın nedeni ürün değil, alıcının seçimidir.

En güçlü çeldirici D. “Kusur kabuğun üstünde kalmıştır” cümlesi ona çok yakın durur; ama bu cümle, kaybın ne kadar gereksiz olduğunu göstermek için kurulmuş bir ara adımdır.
...
**Bu parçaya ve tabloya göre aşağıdakilerden hangisine __ulaşılamaz__?**`,
  ...
  secenekler: ["Sıcaklığın en çok yükseldiği aşama taşıma aşamasıdır.", "Ürün, markete ulaşmadan önce iki aşamada 4 °C’de tutulmuştur.", "Araçta ısınan ürün, reyonda eski tazeliğine yeniden kavuşmuştur.", "Kaydedilen en uzun süre soğuk depo aşamasında geçirilmiştir."],
  dogru: 2,
  hatalar: ["metinde var ama ilgisiz: Tabloda en yüksek sıcaklık 11 °C ile soğutmalı araçta görülüyor; bu bilgiye ulaşılabiliyor.", "metinde var ama ilgisiz: Tabloda ön soğutma ve soğuk depo aşamalarının ikisi de 4 °C olarak veriliyor.", null, "metinde var ama ilgisiz: Tabloda soğuk depo 18 saatle en uzun süreli aşama olarak görünüyor."],
  aciklama: `“Ulaşılamaz” sorusunda şıkları metinle ve tabloyla tek tek karşılaştırırsın; desteklenmeyen tek şık cevaptır.

Adım 1: A’yı sına. Tabloda sıcaklıklar 4, 4, 11 ve 5 °C. En yükseği araç aşamasında; ulaşılabilir.
Adım 2: B’yi sına. Ön soğutma ve soğuk depo aşamalarının ikisi de 4 °C; ulaşılabilir.
Adım 3: D’yi sına. Süreler 3, 18, 5 ve 9 saat. En uzunu soğuk depoda; ulaşılabilir.
Adım 4: C’yi sına. Metin tam tersini söylüyor: “kaybedilen tazelik sonraki halkalarda geri kazanılmaz.” Reyonun 5 °C olması bozulmayı yavaşlatır, geri almaz.

En güçlü çeldirici A. İçinde “en çok” geçtiği için abartılı sanılabilir; oysa tablodaki dört değeri karşılaştırınca bu yargı doğrudur.

Sık yapılan hata: Sayısal bir şıkka bakıp tabloyu okumadan “kesin bilgi değil” diye elemek. Tablo verilmişse karşılaştırma yapmak senin işindir. Cevap C.` },

{ id: "tur-pa-2191", kazanim: "T.8.3.16", kademe: 0, zorluk: 3,
  soru: `Aşağıdaki tabloda bir paragrafı oluşturan cümleler numaralanmış olarak verilmiştir.
...
**Numaralanmış cümlelerden hangisi düşüncenin akışını __bozmaktadır__?**`,
  ...
  aciklama: `Akışı bozan cümleyi bulmanın en güvenli yolu şudur: cümleyi çıkar, önceki ile sonraki birbirine bağlanıyorsa o cümle fazladır.

Adım 1: Zinciri çıkar. I işin asıl yarısının hasattan sonra başladığını söylüyor, II ambardaki tehlikeyi anlatıyor, III önlemleri sıralıyor, V önlem alınmazsa ne olacağını söylüyor.
Adım 2: IV’ü çıkar. III ile V kusursuz bağlanır; üstelik V’teki “bu iki önlem” ifadesi doğrudan III’e gönderme yapar.
Adım 3: IV’ün konusu hasat makinesinin kazandırdığı zamandır. Doğru bir bilgidir, tarımla ilgilidir; ama parçanın ambar zincirine hiçbir katkısı yoktur.

En güçlü çeldirici D. V, “bu iki önlem” diye geriye dönüp özetlediği için fazladan bir cümle gibi görünebilir; oysa sonuç cümlesini çıkarırsan parça yarım kalır.
...
**Bu parçada boş bırakılan yere aşağıdakilerden hangisi getirilmelidir?**`,
  gorsel: null,
  secenekler: ["yiyecekleri daha uzun saklayan kaplar ve dolaplar almaktan", "indirimli ürünlerin tamamından büsbütün uzak durmaktan", "dolaba konan her ürünün üzerine tarih yazmaktan", "alışverişi ve pişirmeyi gerçek ihtiyaca göre ayarlamaktan"],
  dogru: 3,
  hatalar: ["kısmen doğru: Saklama koşulu işe yarar ama parçanın saydığı nedenler saklamayla değil, gereğinden çok almak ve pişirmekle ilgili.", "aşırı genelleme: İndirim yalnızca bir örnek olarak veriliyor; metin indirimli ürünü değil, ihtiyaçtan fazlasını almayı eleştiriyor.", "metinde var ama ilgisiz: Tarih metinde geçiyor ama bir çözüm olarak değil, gereksiz yere atılan yoğurdun örneği olarak.", null],
  aciklama: `Boşluğu doldururken parçanın saydığı nedenlere bak; doğru şık, o nedenleri ortadan kaldıran şıktır.

Adım 1: Metnin saydığı alışkanlıkları çıkar: listesiz alışveriş, gereğinden çok paket almak, dolabı görmeden doldurmak, ne pişireceğine son anda karar vermek.
Adım 2: Bu dördünün ortak noktasını bul. Hepsi aynı şeyi söylüyor: ne kadar gerektiği önceden düşünülmüyor.
Adım 3: Boşluktan önceki “dolabı daha sık boşaltmaktan değil” ifadesi, çözümün saklamayla değil planlamayla ilgili olacağını haber veriyor.
